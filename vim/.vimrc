...
" Vim UI {{{
    ...
    "set colorcolumn=+1 " Vertical line positioned relatively to textwidth setting
    ...
    set synmaxcol=10000 " Stop highlighting lines beyond this length
...
" Mappings {{{
    " Fix Meta keys {{{
        ...
        while c <= 'z'
            ...
            execute "set <M-".toupper(c).">=\e".toupper(c)
            execute "imap \e".toupper(c)." <M-".toupper(c).">"
    ...
    " Delete/Backspace {{{
        ...
        nnoremap <C-h> a<Left><Backspace><Right><Esc>
    " }}}
    " Break undo chain (Tip #1054) {{{
        inoremap <CR> <C-g>u<CR>
    " }}}
    " Insert Space in visual mode {{{
...
"
    ...
    " Replay history {{{
        ...
        command! -nargs=0 ReplayChanges :call <sid>HistReplay()
    " }}}
" }}}
